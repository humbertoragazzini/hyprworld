    ...
    <main className=" w-full h-screen flex justify-center items-center">
      <div className="w-full h-full text-[#96a4b2]">
        <div className="flex h-screen bg-gradient-to-b from-[#0f161c] to-[#212b35] text-gray-100 font-sans">
          {/* Sidebar */}
          <aside className="w-18 bg-[#0f161c] flex flex-col items-center space-y-2 shadow-md border-r-2 border-[#1e343f]">
            <div className="h-[68px] w-full left-0 top-0 bg-[radial-gradient(circle_at_top_left,_#2f3554,_#2f4542)] pb-[1px]">
              <div className="bg-[#1e222c] h-[67px] w-full">
                <button className="w-[50px] aspect-square m-2">
                  <SlScreenDesktop
                    fill="#ffffff"
